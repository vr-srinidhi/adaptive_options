...
export default function RunBuilder() {
  ...
  }, [runType, strategyId, config.trade_date, config.entry_time, config.capital, config.instrument, config.wing_width_steps, config.target_amount, config.stop_loss_amount, config.target_pct, config.stop_capital_pct, config.atm_snap, config.delta_hedge_enabled, config.delta_threshold, config.max_hedge_triggers, config.reentry_buffer, config.vix_guardrail_enabled, config.vix_min, config.vix_max])

...
def _serialize_session(s: LivePaperSession) -> Dict:
    return {
        ...
        "net_delta_latest":  float(s.net_delta_latest) if s.net_delta_latest is not None else None,
        "delta_hedge_status": s.delta_hedge_status,
        "delta_hedge_count": s.delta_hedge_count,
